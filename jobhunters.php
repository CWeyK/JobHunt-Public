...
<html>
    <body>
        ...
        <section class="job-filter">
                <h1 class="heading">Filter JobHunters</h1>
                <form action="jobhunters.php" method="post">
                    <div class="flex">
                        <div class="box">
                    ...
                    <div class="dropdown-container">
                        ...
                        <div class="dropdown">
                            <input type="text" readonly placeholder="Experience" name="experience" maxlength="20" class="output">
                            <div class="lists">
                                <p class="items">None</p>
                                <p class="items">1 Year</p>
                                <p class="items">2-3 Years</p>
                                <p class="items">3-5 Years</p>
                                <p class="items">5-10 Years</p>
                                <p class="items">10+ Years</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box-container">
                <?php foreach($jobs as $job){ ?>
                    ...
                    <div class="tags">
                        ...
                        <p><i class="fas fa-regular fa-clock"></i><span><?=$job['experience']?> Years</span></p>
                    </div>
                    <div class="flex-btn">
                        <a href="view_jobhunter.php?hid=<?=$job['hid']?>" class="btn">View JobHunter</a>
                    </div>
                </div>
                <?php }?>
